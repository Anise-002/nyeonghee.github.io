$(function(){
    ...
    //         $("body").css("background","url(../images/avengers_wallpaper.jpg) no-repeat center center fixed").css("background-size","cover")
    //     }else if(height > 800){
    //         $("body").css("background","linear-gradient(rgb(1, 1, 1) 22%, #bb0f0f 30%, #3f0000 45%, #920c0c 60%, #3f0000 75%, #920c0c 90%)")
    //     }
    // });
